...
const articles = [
...

  {
    ...
    title: "Adjusting Billing for Individual Monthly Membership",
    module: 'membership',
    role: 'all',
    dateUpdated: '2026-03-03',
    version: '2.0',
    ...
    relatedIds: [],
    media: [],
    content: "# RTJ: Update Billing for Monthly Individual Annual Trail Pass Holders\n\n## Overview\n\nUse this procedure To correctly adjust the monthly billing amount for **\"Individual Annual Trail Pass\"** holders who renewed under previous (2025) pricing before a rate increase went into effect.\n\nMembers who purchased or renewed their monthly individual pass in 2025 are entitled to the 2025 pricing (e.g., $2,460 total, or $205/month). However, the system may currently display the updated 2026 pricing (e.g., $223.75/month). It is highly important to manually update these specific profiles so these members are billed the correct grandfathered amount.\n\n**The numbers in this article are examples.** Your member's amounts will be different depending on when they purchased and which pricing tier applies.\n\n\n**Step 1: Locate the Member's Profile**\n\n- Navigate to the **Customers** module.\n- Search for the specific member (e.g., \"Tommy\") and **double-click** into their profile.\n\n**Step 2: Verify Membership Status and Expiration**\n\n- Navigate to the **Member Info** tab.\n- Verify that the member holds the **\"Individual Monthly\"** pass.\n- Check the expiration date to confirm their cycle (e.g., expires at the end of July 2026).\n\n**Step 3: Review the Purchase Date and Current Billing**\n\n- Navigate to the **Membership** tab.\n- Check the original purchase date. If the pass was purchased in 2025 (e.g., July 2025), they are entitled to the 2025 legacy pricing.\n- Review the current billing amount displayed. You will likely see it is set to the incorrect updated pricing (e.g., $223.75 per month).\n\n**Step 4: Edit the Billing Amount**\n\n- Click the **View/Edit Billing** button.\n- Change the billing amount from the new price, for example, $223.75, to the correct legacy price, **$205.00**.\n\n**Step 5: Save and Confirm**\n\n- Click **Save** to lock in the new amount.\n- The monthly billing is now successfully updated. Repeat this process for all monthly individual members who renewed in 2025 for 2026.",
  },
