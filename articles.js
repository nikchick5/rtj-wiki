...
const articles = [
...

  {
    ...
    relatedIds: [],
    media: [],
    content: "## Overview\nTo correctly configure the billing profile of a secondary member (sub-member) on a couples annual pass or trail pass. This ensures the secondary member is not erroneously billed when they have their own independent member account number, as the primary account holder pays the full membership fee.\n\n**Context:** \nNormally, sub-members roll under the main membership number. However, in setups where the secondary member is assigned their own specific card and member account number, the system may automatically generate a billing amount on their individual profile. **It is critical to zero this out to prevent double-charging.**\n\n**Step-by-Step Process:**\n\n**Step 1: Locate the Secondary Member’s Profile**\n\n- Navigate to the **Customers** module.\n- Use the search function to look up the secondary member by their unique member account number (e.g., *30303220*).\n- Open their specific customer profile.\n\n**Step 2: Verify the Membership Status**\n\n- Within the customer profile, click into **Member Info**.\n- Verify that they are correctly tagged with the Annual Pass or Couples Membership.\n\n> **Note:** Because they have their own account, you will notice they do not have any sub-members listed under their own account.*\n\n**Step 3: Access the Membership Billing Tab**\n\n- Navigate to the **Membership tab** located within their profile.\n- Review the current billing setup. You will likely see an active billing amount listed on their profile.\n- *Verification Step:* Unlike the primary account holder (who was previously set up with the correct billing amounts), this secondary member will likely have **no credit on their ledger**.\n\n**Step 4: Edit and Zero Out the Billing Amount**\n\n- Click to **edit the billing amount** within the Membership tab.\n- **Change every billing field to zero ($0.00).**\n- Because this person is the secondary member on a couple's pass, they should not be paying anything individually.\n\n**Step 5: Save and Confirm**\n\n- Review the screen to ensure there are **zeros across the board**.\n- Click **Save**.\n- The profile is now complete, ensuring the couple's membership will not be double-charged.",
  },
