...
const articles = [
...

  {
    ...
    relatedIds: [],
    media: [],
    content: "## Overview\nIn this example, each person on a couple's pass has their own member account and card. The primary account holder is billed for the full pass. The secondary member should never be billed — their billing fields must be set to $0.00. If this isn't done, the couple gets charged twice.\n> **Note:** Complete the primary member's billing setup before starting this procedure.\n---\n## Step 1: Pull Up the Secondary Member's Profile\nSearch for the secondary member by name or member number and double-click to open their profile.\nClick the **Member Info** tab to confirm this is the secondary member. Secondary members will have no sub members listed on their account.\n![](screenshots/member-info-no-sub-members.png)\n---\n## Step 2: Check the Membership Tab\nClick the **Membership** tab. You'll see a billing amount currently on their profile — this is what needs to be corrected.\nNote that unlike the primary account holder, this member will have **no ledger credit**. That's expected.\n![](screenshots/secondary-member-billing-amount.png)\n---\n## Step 3: Zero Out All Billing Amounts\nClick **View/Edit Billing**.\nSet every billing amount field to **$0.00**. Go through each field and make sure nothing is left with a dollar amount.\n![](screenshots/billing-all-zeroed.png)\nConfirm that every field reads $0.00, then click **Save**.\n![](screenshots/billing-save.png)",
  },
